//
//  MarshalHomeViewController.swift
//  FireEvacuation
//
...
class MarshalHomeViewController: UIViewController, UIScrollViewDelegate{
...
extension MarshalHomeViewController: UITableViewDelegate, UITableViewDataSource {
            ...
            if let jsonData = data {
                do {
                    ...
                    if let convDict = json as? [String: Any] {
                        print(convDict)
                        if let statusKey = convDict["status"] as? String {
                            print(statusKey)
                        }
